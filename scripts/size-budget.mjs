...
// Ceiling for total gzipped dist JS. Current footprint ~29 KB gzipped;
// ~38% headroom. Raise deliberately (with a CHANGELOG note) when the kit grows.
const BUDGET_GZIP_KB = 40;
